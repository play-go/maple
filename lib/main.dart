...
import 'gradient_shader_widget.dart';
    ...
    if (Random().nextInt(100) <= 90) {
      ...
      switch (Random().nextInt(6) + 1) {
        ...
        case 4:
          ...
          break;
        case 5:
          await windowManager.setTitle("🍁 | Компилятор VoxelWorld");
      }
    }
  });
...
class _MyHomePageState extends State<MyHomePage> with WindowListener {
      ...
      if (entity is Directory) {
        ...
        if (await launcherFile.exists()) {
          try {
            ...
            errterm(
              terminal,
              "У папки ${entity.path} возникают проблемы при инициализации",
            );
  ...
  List<fl.MenuFlyoutItem> genphoto(setStateDialog) {
    ...
    for (var i in Directory("assets/icons").listSync()) {
                                  ...
                                  items: [
                                    ...
                                    fl.MenuFlyoutItem(
                                      onPressed: () {
                                        ...
                                        prefs.set("frag", "earthbound.frag");
                                        changed = true;
                                        setStateDialog(() {});
                                      },
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: fl.FilledButton(
                        onPressed: profiles.isNotEmpty ? startthisshit : null,
                        child: Text("Запуск"),
                      ),
                    ),
                    SizedBox(
                      ...
                      width: 37,
                      child: fl.FilledButton(
                        onPressed: profiles.isNotEmpty ? debugthisshit : null,
          ...
          fl.PaneItem(
            ...
            body: Stack(
              children: [
                ...
                //         end: Alignment(0.8, 1),
                //         colors: <Color>[
                //           Color(0xff4b0e0e), // Темный бордовый
                //           Color(0xff6e1e12), // Темный красно-коричневый
                //           Color(0xff8c3b10), // Темный оранжево-коричневый
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  Positioned.fill(
                                    child: fl.Card(
                                      borderRadius: BorderRadius.zero,
                                      // backgroundColor: fl.Colors.grey.withAlpha(
                                      //   222,
                                      // ), Если не хочется acrylic использовать
                                      padding: EdgeInsets.zero,
                                      child: Container(
                                        alignment: Alignment.center,
  ...
  // void nu() { // Старые настройки, оставлю этот мусор здесь
  //   [
  // fl.PaneItem(
  //   icon: Container(),
  //   body: Column(
  ...
  //                         //   child: Text("Скрыть прогресс бар"),
  //                         //   onChanged:
  //                         //       (bool s) => setState(() {
  //                         //         hideProgress = s;
  //                         //         prefs.set("lurkprogressbar", s);
  //                         //       }),
  //                         // ),
  //                       ],
  //                     ),
